...
public partial class NewUnitWiseUpdate : System.Web.UI.Page
{
    ...
    protected void Button8_Click(object sender, EventArgs e)
    {
        ...
        if (txtActualdate.Text == "")
        {
            ...
            n = d.insertnewmilestonedalnull(b);

        }
        else
        {
            b.insertnewbal(dropprojectname.Text, dropblock.Text, dropplot.Text,dropfloor.Text,dropunit.Text, dropmilestone.Text, txtActualdate.Text, txtupdatedate.Text);
            n = d.insertnewmilestonedal(b);
        }
