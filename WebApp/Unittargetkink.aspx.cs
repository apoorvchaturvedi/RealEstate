...
public partial class Default2 : System.Web.UI.Page
{
    ...
    protected void LinkButton2_Click(object sender, EventArgs e)
    {
        ...
        Application["ActualDate"] = Actual.ToString();
        Application["Plot"] = plot.ToString();
        Application["ID"] = Id;
        Response.Redirect("TestNewunittargetkink.aspx?milestone=" + a + "&projectName=" + f + "&Blockname=" + c + "&ActualDate=" + Actual + "&PlotName=" + plot + "&ID=" + Id);
