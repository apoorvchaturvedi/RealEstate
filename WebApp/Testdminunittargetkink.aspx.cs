...
public partial class Newunittargetkink : System.Web.UI.Page
{
    ...
    protected void Button6_Click(object sender, EventArgs e)
    {
        ...
        if (txtActualdate.Text == ""&&txtremark.Text == "")
        {
            ...
            n = d.inserttargetdatenulldal(dropprojectname.Text, dropblock.Text, dropplot.Text, dropmilestone.Text, txtupdatedate.Text);
          
        }
        else
        {
            //b.insertbal();
            n = d.insertmilestonTarget(dropprojectname.Text, dropblock.Text, dropplot.Text, dropmilestone.Text, txtActualdate.Text, txtupdatedate.Text, txtremark.Text);
        }
        ...
        if (n>=1)
        {
            ...
            txtActualdate.Text = "";
            Response.Redirect("AdminUnittargetlink.aspx");
        }
