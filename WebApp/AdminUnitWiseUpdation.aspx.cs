...
public partial class UnitWiseUpdation : System.Web.UI.Page
{
    ...
    protected void LinkButton2_Click(object sender, EventArgs e)
    {
        ...
        Session["remark"] = Unit.ToString();


        Response.Redirect("AdminNewUnitWiseUpdate.aspx?milstone=" + a + "&projectName=" + f + "&Blockname=" + c + "&ActualDate=" + Actual + "&PlotName=" + plot + "&ID=" + Id + "&floor=" + floor + "&Unit=" + Unit+"&remark="+remark);
        //bindgridview();
    }
