<%@ Page Title="BPTP" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="AddProject.aspx.cs" Inherits="AddProject" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:Panel ID="Panel2" runat="server" BorderColor="Blue" BorderWidth="3px" 
        GroupingText="New Project Add Information" Font-Bold="True">
            ...
            <tr>
                <td colspan="4" style="text-align: center">
                    <asp:Button ID="Button6" runat="server" CssClass="style13" Font-Bold="True" 
                        Height="27px" onclick="Button6_Click" OnClientClick="return validate();" 
                        Text="Save" Width="66px" />
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Button ID="Button8" runat="server" CssClass="style13" 
                        Font-Bold="True" Height="27px" onclick="Button8_Click" Text="Cancel" 
                        Width="66px" />
                </td>
            </tr>
            <tr>
